...
export type AnimalStatus = 'En Adopción' | 'Reservado' | 'Reservada' | 'En residencia' | 'Busca acogida urgente' | 'Pronto en adopción' | 'Pendiente de Adopción' | 'Adoptado' | 'Adoptada';
