  ...
  return (
    <div className="min-h-screen py-16 bg-white dark:bg-stone-900 transition-colors duration-300">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <h1 className="text-3xl md:text-4xl font-serif font-bold text-stone-800 dark:text-stone-100 mb-8">Política de Privacidad</h1>
        ...
        <div className="text-stone-600 dark:text-stone-300 space-y-6 leading-relaxed">
          ...
          <h2 className="text-2xl font-serif font-bold text-stone-800 dark:text-stone-100 mt-8 mb-4">Información que es recogida</h2>
          <p>
          ...
          <h2 className="text-2xl font-serif font-bold text-stone-800 dark:text-stone-100 mt-8 mb-4">Uso de la información recogida</h2>
          <p>
          ...
          <h2 className="text-2xl font-serif font-bold text-stone-800 dark:text-stone-100 mt-8 mb-4">Enlaces a Terceros</h2>
          <p>
          ...
          <h2 className="text-2xl font-serif font-bold text-stone-800 dark:text-stone-100 mt-8 mb-4">Control de su información personal</h2>
          <p>
